...
# =============================================================================
# Test 6: Combined presets
# =============================================================================
echo ""
echo "── Combined preset tests ──"

preset_out=$(test_preset "mowgli" "ubx-uart" "ldlidar-uart" "front")
...
preset_out=$(test_preset "mowgli" "nmea-usb" "rplidar-usb" "both")
...
# =============================================================================
# Test 7: Consistency with existing installer values
# =============================================================================
echo ""
